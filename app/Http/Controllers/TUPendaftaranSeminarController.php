...
class TUPendaftaranSeminarController extends Controller
{
    ...
    public function edit_keterangan_kelolosan($id)
    {
        ...
        return redirect('/tu/pendaftaran-seminar')->with('success', 'Status kelolosan telah diperbarui!');
    }
    ...
    public function update($id)
    {
        ...
        if (request('status') != $pendaftaran->status) {
            ...
            return redirect('/tu/pendaftaran-seminar')->with('success', 'Pendaftaran telah diperbarui!');
        }
    }
