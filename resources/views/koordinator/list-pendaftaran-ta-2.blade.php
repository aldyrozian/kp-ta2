            ...
            <table class="table table-hover table-sm mt-3">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a class="btn" href="/koordinator/list-pendaftaran-ta-2/{{ $pendaftaran->id }}"
                                style="background-color:#ff8c1a;"><i class="fa-solid fa-align-left"></i> Detail</a>
                            <!-- <a class="btn btn-warning"
                                href="/koordinator/list-pendaftaran-ta-2/{{ $pendaftaran->id }}/edit"><i
                                    class="fa-regular fa-pen-to-square"></i> Edit</a>
                            <form action="/koordinator/list-pendaftaran-ta-2/{{ $pendaftaran->id }}" method="post"
                                class="d-inline">
                                @method('delete')
                                @csrf
