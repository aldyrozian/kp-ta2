...
<div class="row align-items-start mt-3">
    <div class="row g-3">
        ...
        <div class="row mt-4">
            <div class="col-md-6">
                ...
                <a class="btn" style="width: 12rem; background-color:#ff8c1a;"
                    href="{{ route('ajuan-pembimbing.downloadBerkasta2',$pendaftaran->id) }}">Download
        ...
        <div class="row mt-4">
            <div class="col-md-6">
                ...
                <a class="btn" style="width: 12rem; background-color:#ff8c1a;"
                    href="{{ route('ajuan-pembimbing.downloadKHS',$pendaftaran->id) }}">Download <i
    ...
    <div class="col-12 mt-5">
        <a class="btn" href="{{ route('ajuan-pembimbing-2.index') }}" role="button"
