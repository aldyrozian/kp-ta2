...
<div class="row align-items-start mt-3">
    <div class="row g-3">
        ...
        <div class="row mt-4">
            <div class="col-md-7">
                ...
                <a class="btn" style="width: 12rem; background-color:#ff8c1a;"
                    href="/tu/pendaftaran-administrasi/{{ $pendaftaran->id }}/downloadTagihanUang">Download <i
                        class="fa-solid fa-download"></i>
                </a>
            </div>
        </div>
        <div class="row mt-4">
            <div class="col-md-7">
                ...
                <a class="btn" style="width: 12rem; background-color:#ff8c1a;"
                    href="/tu/pendaftaran-administrasi/{{ $pendaftaran->id }}/downloadLunasPembayaran">Download
        ...
        <div class="row mt-4">
            <div class="col-md-7">
                ...
                <a class="btn" style="width: 12rem; background-color:#ff8c1a;"
                    href="/tu/pendaftaran-administrasi/{{ $pendaftaran->id }}/downloadKhs">Download <i
                        class="fa-solid fa-download"></i>
                </a>
            </div>
        </div>
        ...
        <div class="d-flex justify-content-center mt-3 ">
            ...
            <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                <div class="btn-group" role="group" aria-label="Basic example">
                    <form method="post" action="/tu/pendaftaran-administrasi/{{ $pendaftaran->id }}">
                        @method('put')
                        @csrf
                ...
                <a class="btn btn-warning" href="/tu/pendaftaran-administrasi/{{ $pendaftaran->id }}/lolos-bersyarat"
                ...
                <a class="btn btn-dark" href="/tu/pendaftaran-administrasi/{{ $pendaftaran->id }}/tidak-lolos"
            ...
            <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                ...
                <a class="btn btn-warning disabled"
                    href="/tu/pendaftaran-administrasi/{{ $pendaftaran->id }}/lolos-bersyarat" role="button"
            ...
            <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                ...
                <a class="btn btn-dark disabled" href="/tu/pendaftaran-administrasi/{{ $pendaftaran->id }}/tidak-lolos"
                    role="button" style="width: 10rem; height: 3rem;">Tidak Lolos</a>
            </div>
            @endif
        </div>
    ...
    <div class="col-12 mt-5">
        <a class="btn" href="{{ route('pendaftaran-administrasi.index') }}" role="button"
